...
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{60pt}ccccccccc}
\toprule
...
\multicolumn{10}{l}{\rule{0pt}{1em}Note: All models include country and year fixed effects. Standard errors clustered by country, and 95\% confidence intervals are presented in square brackets.}\\
