...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "Female and Male Child Mortality before 5",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "Male minus Female Child Mortality before 5",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
...
modelsummary(
  ...
  coef_rename = coef_map,
  statistic = stat_map,
  title = " Full Diff in Diff and IV regressions (with country weights exlcuding China and India)",
  coef_omit = "Intercept",
  gof_map = gm_map,
  escape = FALSE,
  format = "latex",
