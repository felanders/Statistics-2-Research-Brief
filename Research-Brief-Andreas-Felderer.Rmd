...
-   Quota, quotayear, women_parliament
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "Maternal Mortality Ratio Base Model",
...
models_mmr_cont[["Base"]] <- lm_robust(
  log(MMR_WDI) ~  log(gdp_pc) + lag(quota, 2),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
...
models_mmr_cont[["Gender Policy"]] <- lm_robust(
...
models_mmr_cont[["Health Expenditure"]] <- lm_robust(
...
models_mmr_cont[["Health Expenditure & Primary Education"]] <- lm_robust(
  log(MMR_WDI) ~  log(gdp_pc) + lag(quota, 2) + HEA_EXP + EDU_PRIM_WDI,
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_mmr_cont[["Full"]] <- lm_robust(
  log(MMR_WDI) ~  log(gdp_pc) + lag(quota, 2) + log(gdp_pc*HEA_EXP) + EDU_PRIM_WDI,
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_control[["ln(MMR)"]] <- models_mmr_cont[["Full"]]
...
modelsummary(
  ...
  gof_omit = "se_type") %>% 
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/MMR_controls.tex")
```

# IV

```{r hypothesis}
lm_iv_power <- lm_robust(
  women_parliament ~ quota,
  weights = pop,
  data=df_w)
summary(lm_iv_power)
```
...
models_iv[["(1)"]] <- iv_robust(
  MMR_WDI ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
models_iv[["(4)"]] <- iv_robust(
  TFR_WDI ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
models_iv[["(7)"]] <- iv_robust(
  I5M_WDI ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
modelsummary(
  ...
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/IV_base.tex")
```
...
models_iv_ln[["(1)"]] <- iv_robust(
  log(MMR_WDI) ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
models_iv_ln[["(4)"]] <- iv_robust(
  log(TFR_WDI) ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
models_iv_ln[["(7)"]] <- iv_robust(
  log(I5M_WDI) ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df, 
  fixed_effects = year + dhscc3,
  se_type = "CR0")
...
modelsummary(
  ...
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt")  %>% save_kable("tables/IV_LN_base.tex")
```
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "Total Fertility Rate Base Model",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
  ...
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/TFR_base.tex")
```
...
models_tfr_cont[["Base"]] <- lm_robust(
  log(TFR_WDI) ~  log(gdp_pc) + lag(quota, 2),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
...
models_tfr_cont[["Gender Policy"]] <- lm_robust(
...
models_tfr_cont[["Health Expenditure"]] <- lm_robust(
...
models_tfr_cont[["Health Expenditure & Primary Education"]] <- lm_robust(
  log(TFR_WDI) ~  log(gdp_pc) + lag(quota, 2) + HEA_EXP + EDU_PRIM_WDI,
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_tfr_cont[["Full"]] <- lm_robust(
  log(TFR_WDI) ~  log(gdp_pc) + lag(quota, 2)  + EDU_PRIM_WDI + I5M_WDI + log(gdp_pc*HEA_EXP),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_control[["ln(TFR)"]] <- models_tfr_cont[["Full"]]
...
modelsummary(
  ...
  gof_omit = "se_type") %>% 
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/TFR_controls.tex")
```
...
tfr_comp[["ln(TFR)"]] <- models_tfr[["(9)"]]
tfr_comp[["IV TFR"]] <- models_iv[["(6)"]]
tfr_comp[["IV ln(TFR)"]] <- models_iv_ln[["(6)"]]
tfr_comp[["ln(TFR) + Controls"]] <- models_tfr_cont[["Full"]]

modelsummary(
  tfr_comp,
  fmt = 2,
  stars = T, 
  title = "Total Fertility Rate (with country weights exlcuding China and India)",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "Child Mortality before 5 Base Model",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
  ...
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/I5M_base.tex")
```
...
models_i5m_cont[["Base"]] <- lm_robust(
  log(I5M_WDI) ~  log(gdp_pc) + lag(quota, 2),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
...
models_i5m_cont[["Gender Policy"]] <- lm_robust(
...
models_i5m_cont[["Health Expenditure"]] <- lm_robust(
...
models_i5m_cont[["Health Expenditure & Primary Education"]] <- lm_robust(
  log(I5M_WDI) ~  log(gdp_pc) + lag(quota, 2) + HEA_EXP + EDU_PRIM_WDI,
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_i5m_cont[["Full"]] <- lm_robust(
  log(I5M_WDI) ~  log(gdp_pc) + lag(quota, 2)  + EDU_PRIM_WDI  + log(gdp_pc*HEA_EXP),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_control[["ln(I5M)"]] <- models_i5m_cont[["Full"]]
models_control[["I5M"]] <- lm_robust(
  I5M_WDI ~  log(gdp_pc) + lag(quota, 2)  + EDU_PRIM_WDI  + log(gdp_pc*HEA_EXP),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "ln(Child Mortality before 5) Controls",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
  ...
  gof_omit = "se_type") %>% 
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/I5M_controls.tex")
```
...
```{r i5m fm}
models_i5m_fm <- list()
models_i5m_fm_iv <- list()

models_i5m_fm[["Base Female"]] <- lm_robust(
...
models_i5m_fm[["Base Male"]] <- lm_robust(
...
models_i5m_fm[["Full Female"]] <- lm_robust(
  log(I5M_F_WDI) ~  log(gdp_pc) + lag(quota, 2)  + EDU_PRIM_WDI + EDU_PRIM_F_WDI +
    EDU_PRIM_M_WDI + log(gdp_pc*HEA_EXP),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_i5m_fm[["Full Male"]] <- lm_robust(
  log(I5M_M_WDI) ~  log(gdp_pc) + lag(quota, 2) + EDU_PRIM_WDI + EDU_PRIM_F_WDI +
    EDU_PRIM_M_WDI + log(gdp_pc*HEA_EXP),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
...
models_i5m_fm_iv[["Female"]] <- iv_robust(
  I5M_F_WDI ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_i5m_fm_iv[["Male"]] <- iv_robust(
  I5M_M_WDI ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_i5m_fm_iv[["ln(Female)"]] <- iv_robust(
  log(I5M_F_WDI) ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
models_i5m_fm_iv[["ln(Male)"]] <- iv_robust(
  log(I5M_M_WDI) ~ log(gdp_pc) + women_parliament | quota + log(gdp_pc),
  clusters = dhscc3,
  data = df_w, 
  weights = pop,
  fixed_effects = year + dhscc3,
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "ln(Child Mortality before 5) Female and Male",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
...
modelsummary(
  ...
  fmt = 2,
  stars = T, 
  title = "IV for Child Mortality before 5 Female and Male",
  coef_rename = coef_map,
  statistic = stat_map,
  coef_omit = "Intercept",
  gof_map = gm_map,
  ...
  gof_omit = "se_type") %>% 
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/I5M_fm_iv.tex")
```
...
i5m_comp[["ln(I5M)"]] <- models_i5m[["(9)"]]
i5m_comp[["IV I5M"]] <- models_iv[["(9)"]]
i5m_comp[["IV ln(I5M)"]] <- models_iv_ln[["(9)"]]
i5m_comp[["ln(I5M) + Controls"]] <- models_i5m_cont[["Full"]]
...
modelsummary(
  ...
  gof_omit = "se_type") %>% 
  kable_styling(full_width = T) %>% 
  column_spec(1, width="60pt") %>% save_kable("tables/Controls.tex")
```
...
-   Use a similar IV approach to produce results as shown in table A4 in the paper.

-   Explain the choice of the IV variable and discuss whether you think that the IV a valid.
